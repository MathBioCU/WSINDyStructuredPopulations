...
BoundaryParams.gaussian.x_peak =[5:5:15]; 
BoundaryParams.gaussian.sigma = [5];
BoundaryParams.gaussian.scale = [5^2*sqrt(2*pi)];
...
SourceParams.exponential.x0 = []; %used for scaling

TrueTags = {["a^0*u"],["a^2*u","N^1*a^2*u"],["a^1*u","N^1*a^1*u"]};

%% Set Boundary Trial function params
% 1. Polynomial: b(x,u) = x^p *u
BoundaryParams.polynomial.p = [0:2];
...
SourceParams.exponential.k = [];0.08:0.32:1.32;% [0.05];0.08:0.02:0.16;
...
SourceParams.NL.Logistic.k = [-1,1];

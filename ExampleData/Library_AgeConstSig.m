...
BoundaryParams.sigmoid.x_mid =[8,10];%[3];
BoundaryParams.sigmoid.k = [2];%2;
% 3. Gaussian: b(x,u) = exp( -(x-x_peak)^2/(2sigma^2)) *u
BoundaryParams.gaussian.x_peak = [10,15,20];
BoundaryParams.gaussian.sigma = [2];
...
BoundaryParams.NL.Logistic.k = [1:2]; [1];
...
SourceParams.exponential.k =[];[0.05,0.8];% [0.05];

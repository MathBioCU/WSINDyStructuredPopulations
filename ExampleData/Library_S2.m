TrueTags = {["a^1*u","a^2*u"],["exp(0.2x)*u"],["a^1*u"]};

%% Set Boundary Trial function params
% 1. Polynomial: b(x,u) = x^p *u
BoundaryParams.polynomial.p = [1:4];
...
SourceParams.exponential.k =0.2 + 0.5*[0:3]; ;% [0.05];0.08:0.02:0.16;
...
TransportParams.polynomial.p = [0:4];

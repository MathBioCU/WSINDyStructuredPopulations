...
%     XiBias = sparsifyDynamics(Theta_0(:,libEntry),dXdt(:,iii),lambda,gamma,M);
    ...
    [XiBias,its,thrs_EL] = sparsifyDynamics(Theta_0(:,libEntry),dXdt(:,iii),lambda,1,gamma,M_0(libEntry));
...
if ~LBp.DB
    ...
    for iii = 1:n
        ...
        MIn = M_0(libEntry);
        bootstatDD = bootstrp(nEnsemblesDD,@(ThetaIn,dxIn)sparsifyDynamics(ThetaIn,dxIn,lambda,1,gamma,MIn),Theta_0(:,libEntry),dXdt(:,iii)); 
